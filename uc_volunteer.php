...
if (isset($_POST['save_activity'])) {
    uc_activity::save_uc_activity($_GET['activity_id'], trim($_POST['input_program_name']), trim($_POST['textarea_activity_describe']), trim($_POST['textarea_activity_did']), $_POST['CheckBoxGrade'], trim($_POST['input_hour_spent']), trim($_POST['input_weeks_spent']), null, null, null, null);
...
<head>
    ...
    <title>UC Application Volunteer Edit - Proactivity</title>
</head>
<body>
    <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div style="width: 80%; margin: auto">
            ...
            <div class="row" style="margin-top: 25px">
                <div class="col-2">
                    <h7>What's the name of the organization, program, school or group you volunteered for? *</h7>
                </div>
                <div class="col-8" style="text-align: left">
                    <input type="text" name="input_program_name" class="form-control" aria-describedby="basic-addon1" maxlength="60" value="<?php echo $cur_obj['Organization_Program_Course_Name']; ?>" />
                </div>
            ...
            <div class="row" style="margin-top: 30px">
                <div class="col-2">
                    Please describe the organization, program, school or group. *<span style="font-size: small">(Consider what kind of work the organization does: What’s the reason the organization exists today? How does it help a certain community or population?)</span>
                </div>
                <div class="col-8" style="text-align: left">
            ...
            <div class="row" style="margin-top: 40px">
                <div class="col-2">
                    <h7>When did you volunteer? *</h7>
                    <span style="font-size: small">(If you volunteered during the summer, select the grade you were in before you volunteered.)</span>
                </div>
            ...
            <div class="row" style="margin-top: 40px">
                <div class="col-2">
                    <h7>How much time did you spend volunteering? *</h7><span style="font-size: small">(It's ok to estimate, but try to be as accurate as possible.)</span>
                </div>
                <div class="col-5">
