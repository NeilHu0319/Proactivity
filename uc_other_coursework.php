...
<head>
    ...
    <title>UC Application Other CourseWork Edit - Proactivity</title>
</head>
<body>
    <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div style="width: 80%; margin: auto">
            ...
            <div class="row" style="margin-top: 25px">
                <div class="col-2">
                    <h7>What was the course name? *</h7>
                </div>
            ...
            <div class="row" style="margin-top: 30px">
                <div class="col-2">
                    Briefly describe the course. *.<span style="font-size: small">(What program or school offered the course? Also, think about describing the major themes or topics the course covered, as well as what knowledge or skills you learned.)</span>
                </div>
                <div class="col-8" style="text-align: left">
            ...
            <div class="row" style="margin-top: 30px">
                <div class="col-2">
                    <h7>When did you take this course? *</h7>
                    <span style="font-size: small">(If you took this course during the summer, select the grade you were in before that summer.)</span>
                </div>
            ...
            <div class="row" style="margin-top: 30px">
                <div class="col-2">
                    <h7>How much time did you spend in class? *</h7><span style="font-size: small">(It's ok to estimate, but try to be as accurate as possible.)</span>
                </div>
                <div class="col-5">
